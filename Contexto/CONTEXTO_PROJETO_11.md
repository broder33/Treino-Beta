...
>
> 1. Leia **"SESSÃO 13 — MODELO CONTÍNUO"** (fim do documento). É o estado atual.
> 2. Leia **"PENDÊNCIAS — FIM DA SESSÃO 13"**. Há uma decisão de produto esperando resposta
>    do usuário (o botão LIMPAR HISTÓRICO) e a **Etapa 5 inteira** por fazer.
> 3. A suíte de testes tem **439 testes** e roda em segundos. **Rode antes e depois de cada
>    alteração.** Ver "SUÍTE DE TESTES".
>
